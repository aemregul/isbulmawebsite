                ...
                <div className="bg-white/[0.08] backdrop-blur-xl rounded-3xl p-8 sm:p-10 border border-white/[0.12] shadow-2xl shadow-black/20">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <motion.button
                            ...
                            type="submit"
                            disabled={loading}
                            className="w-full py-3.5 bg-gradient-to-r from-[#2623D2] to-[#116DFF] text-white font-semibold rounded-xl flex items-center justify-center gap-2 hover:shadow-lg hover:shadow-[#2623D2]/30 transition-all disabled:opacity-60 disabled:cursor-not-allowed"
                        >
                            {loading ? (
